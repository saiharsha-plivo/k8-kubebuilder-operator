...
import (
	...
	"github.com/saiharsha-plivo/k8-kubebuilder-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(servicev1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9b4da625.my.domain",
	...
	if err = (&controller.WebApplicationReconciler{
